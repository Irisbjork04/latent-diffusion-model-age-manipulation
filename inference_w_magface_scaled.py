...
def get_model():
    config = OmegaConf.load("/work3/s212461/logs/2024-02-20T17-35-39_agemodel-ldm-magv2/configs/2024-02-20T17-35-39-project.yaml")  
    model = load_model_from_config(config, "/work3/s212461/logs/2024-02-20T17-35-39_agemodel-ldm-magv2/checkpoints/epoch=000044.ckpt")#"/work3/s212461/logs/2023-12-11T23-10-35_agemodel-ldm-v3/checkpoints/epoch=000028.ckpt")
    return model, config
...
classes = list(range(1181, 20000, 20))
...
for i in classes:#tqdm(range(5)):
   ...
   # image_name = ldm_data.datasets['train'][i]['image']  # Update this to get the correct image name
    ...
    for age in ages_for_sampling:
        ...
        age_one_hot_scaled = age_label * 100
        ...
        age_number2 = index2
        Image.fromarray(denoise_grid.astype(np.uint8)).save(f"results/newV3-magface_onehot-{i}-age-{age_number}_from-{age_number2}_e-0021_run1.png")
