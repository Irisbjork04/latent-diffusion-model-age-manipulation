...
# ÍBS Add here import for the new conditioning class? Noooo
...
__conditioning_keys__ = {"concat": "c_concat", "crossattn": "c_crossattn", "age": "c_age", "adm": "y"}
...
class LatentDiffusion(DDPM):
    ...
    def get_input(
        ...
        if self.model.conditioning_key is not None:
            ...
            if cond_key != self.first_stage_key:
                if cond_key in ["caption", "coordinates_bbox","age"]:
                    xc = batch[cond_key]
    ...
    def p_losses(self, x_start, cond, t, noise=None):
        ...
        t = t.to(self.logvar.device)  # Move t to the device of self.logvar
