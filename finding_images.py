...
classes = list(range(6, 8, 1))

ages_for_sampling = list(range(1, 2))
...
for i in classes:#tqdm(range(5)):
    ...
    #print('ÍBS c1: ', c1)
        ...
        Image.fromarray(denoise_grid.astype(np.uint8)).save(f"FindingImages-{i}-age-{age_number}_from_age-{age_number2}.png")
