...
classes = list(range(10000, 20000, 20))
...
for i in classes:#tqdm(range(5)):
   ...
   # image_name = ldm_data.datasets['train'][i]['image']  # Update this to get the correct image name
    ...
    for age in ages_for_sampling:
        ...
        age_number2 = index2
        Image.fromarray(denoise_grid.astype(np.uint8)).save(f"results_running_now/newV3-magface_onehot-{i}-age-{age_number}_from-{age_number2}_e-0021_run1.png")
